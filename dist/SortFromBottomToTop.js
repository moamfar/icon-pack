...
<path d="M3.25 8C3.25 8.41421 3.58579 8.75 4 8.75H13C13.4142 8.75 13.75 8.41421 13.75 8C13.75 7.58579 13.4142 7.25 13 7.25H4C3.58579 7.25 3.25 7.58579 3.25 8Z"/>
<path opacity="0.7" d="M5.25 13C5.25 13.4142 5.58579 13.75 6 13.75H13C13.4142 13.75 13.75 13.4142 13.75 13C13.75 12.5858 13.4142 12.25 13 12.25H6C5.58579 12.25 5.25 12.5858 5.25 13Z"/>
<path opacity="0.4" d="M7.25 18C7.25 18.4142 7.58579 18.75 8 18.75H13C13.4142 18.75 13.75 18.4142 13.75 18C13.75 17.5858 13.4142 17.25 13 17.25H8C7.58579 17.25 7.25 17.5858 7.25 18Z"/>
</svg>
`,
  "broken": `
...
`,
  "lineDuotone": `
<path d="M4 8H13" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.7" d="M6 13H13" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.4" d="M8 18H13" stroke-width="1.5" stroke-linecap="round"/>
<path d="M17 20V4L20 8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
  "linear": `
...
const SortFromBottomToTop = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
