...
<path fill-rule="evenodd" clip-rule="evenodd" d="M13 1.25C13.4142 1.25 13.75 1.58579 13.75 2C13.75 4.8995 16.1005 7.25 19 7.25C19.4142 7.25 19.75 7.58579 19.75 8C19.75 8.41421 19.4142 8.75 19 8.75C15.2721 8.75 12.25 5.72792 12.25 2C12.25 1.58579 12.5858 1.25 13 1.25Z" fill="currentColor" opacity="0.4"/>
<path opacity="0.5" d="M12.25 14.5359V2C12.25 3.60747 12.8119 5.08371 13.75 6.243V18C13.75 16.6339 13.1733 15.4024 12.25 14.5359Z" fill="currentColor" opacity="0.4"/>
</svg>
`,
  "broken": `
...
<path d="M19 8C15.6863 8 13 5.31371 13 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
`,
  "lineDuotone": `
<path opacity="0.5" d="M13 18V10V2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<circle cx="9" cy="18" r="4" stroke="currentColor" stroke-width="1.5"/>
<path d="M19 8C15.6863 8 13 5.31371 13 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
`,
  "linear": `
<path d="M13 18V10V2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<circle cx="9" cy="18" r="4" stroke="currentColor" stroke-width="1.5"/>
<path d="M19 8C15.6863 8 13 5.31371 13 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
`,
...
const MusicNote2 = ({ size = 24, color = "currentColor", weight = "outline", className = "", style = {}, ...props }) => {
