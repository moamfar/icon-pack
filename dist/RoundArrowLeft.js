...
const RoundArrowLeft = ({ size = 24, color = "currentColor", weight = "outline", className = "", style = {}, ...props }) => {
...
exports.RoundArrowLeft = RoundArrowLeft;
