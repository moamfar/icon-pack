...
exports.ListCheckMinimalistic = void 0;
...
`,
  "boldDuotone": `
<path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M3 6.75C3 6.33579 3.33579 6 3.75 6H20.75C21.1642 6 21.5 6.33579 21.5 6.75C21.5 7.16421 21.1642 7.5 20.75 7.5H3.75C3.33579 7.5 3 7.16421 3 6.75ZM3 11.75C3 11.3358 3.33579 11 3.75 11H10.75C11.1642 11 11.5 11.3358 11.5 11.75C11.5 12.1642 11.1642 12.5 10.75 12.5H3.75C3.33579 12.5 3 12.1642 3 11.75ZM3 16.75C3 16.3358 3.33579 16 3.75 16H10.75C11.1642 16 11.5 16.3358 11.5 16.75C11.5 17.1642 11.1642 17.5 10.75 17.5H3.75C3.33579 17.5 3 17.1642 3 16.75Z"/>
...
`,
  "broken": `
<path d="M10 11L3 11" stroke-width="1.5" stroke-linecap="round"/>
<path d="M10 16H3" stroke-width="1.5" stroke-linecap="round"/>
<path d="M14 13.5L16.1 16L20 11" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<path opacity="0.5" d="M10 11L3 11" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M10 16H3" stroke-width="1.5" stroke-linecap="round"/>
<path d="M14 13.5L16.1 16L20 11" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
  "linear": `
...
const ListCheckMinimalistic = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
...
exports.ListCheckMinimalistic = ListCheckMinimalistic;
