...
`,
    "boldduotone": `
<path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M12 3.25C12.4142 3.25 12.75 3.58579 12.75 4L12.75 13.25H11.25L11.25 4C11.25 3.58579 11.5858 3.25 12 3.25Z"/>
...
`,
    "broken": `
<path d="M12 20L18 14M12 20L6 14M12 20L12 9.5M12 4V6.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
    "lineduotone": `
<path opacity="0.5" d="M12.75 4C12.75 3.58579 12.4142 3.25 12 3.25C11.5858 3.25 11.25 3.58579 11.25 4L12.75 4ZM11.25 4L11.25 20H12.75L12.75 4L11.25 4Z"/>
<path d="M18 14L12 20L6 14" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
    "linear": `
...
export const ArrowDown: React.FC<IconProps> = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
