...
`,
    "boldduotone": `
<path opacity="0.5" d="M2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12Z"/>
...
`,
    "broken": `
<path d="M15 10.5L12 13.5L9 10.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
export const RoundAltArrowDown: React.FC<IconProps> = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
