...
exports.ListArrowDownMinimalistic = void 0;
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M16.9697 17.5303C17.2626 17.8232 17.7374 17.8232 18.0303 17.5303L20.5303 15.0303C20.8232 14.7374 20.8232 14.2626 20.5303 13.9697C20.2374 13.6768 19.7626 13.6768 19.4697 13.9697L18.25 15.1893V9C18.25 8.58579 17.9142 8.25 17.5 8.25C17.0858 8.25 16.75 8.58579 16.75 9V15.1893L15.5303 13.9697C15.2374 13.6768 14.7626 13.6768 14.4697 13.9697C14.1768 14.2626 14.1768 14.7374 14.4697 15.0303L16.9697 17.5303Z" fill="currentColor" opacity="0.4"/>
</svg>
`,
  "broken": `
<path d="M11 16L3 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M12 11L3 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M15 14.5L17.5 17M17.5 17L20 14.5M17.5 17V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<path opacity="0.5" d="M11 16L3 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M12 11L3 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M15 14.5L17.5 17M17.5 17L20 14.5M17.5 17V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
  "linear": `
...
const ListArrowDownMinimalistic = ({ size = 24, color = "currentColor", weight = "outline", className = "", style = {}, ...props }) => {
...
exports.ListArrowDownMinimalistic = ListArrowDownMinimalistic;
