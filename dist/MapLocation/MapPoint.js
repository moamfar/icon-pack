...
<path d="M12 12.5C13.3807 12.5 14.5 11.3807 14.5 10C14.5 8.61929 13.3807 7.5 12 7.5C10.6193 7.5 9.5 8.61929 9.5 10C9.5 11.3807 10.6193 12.5 12 12.5Z" fill="currentColor"/>
</svg>
`,
  "fill": `
...
const MapPoint = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
