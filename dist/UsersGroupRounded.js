...
<ellipse opacity="0.4" cx="16" cy="17" rx="5" ry="3" fill="currentColor" opacity="0.4"/>
<circle cx="9.00098" cy="6" r="4" fill="currentColor" opacity="0.4"/>
<ellipse cx="9.00098" cy="17.001" rx="7" ry="4" fill="currentColor" opacity="0.4"/>
</svg>
`,
  "broken": `
...
const UsersGroupRounded = ({ size = 24, color = "currentColor", weight = "outline", className = "", style = {}, ...props }) => {
