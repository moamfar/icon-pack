...
<path d="M10.5 8.5C10.5 7.67157 11.1716 7 12 7C12.8284 7 13.5 7.67157 13.5 8.5V10.5C13.5 11.3284 12.8284 12 12 12C11.1716 12 10.5 11.3284 10.5 10.5V8.5Z" stroke-width="1.5"/>
<path d="M12 2V7" stroke-width="1.5" stroke-linecap="round"/>
</svg>
`,
  "fill": `
...
const Mouse = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
