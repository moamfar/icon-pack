...
exports.MinimalisticMagniferZoomOut = void 0;
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.02393 11.1565C8.02393 10.7572 8.34758 10.4336 8.74682 10.4336H13.5661C13.9653 10.4336 14.289 10.7572 14.289 11.1565C14.289 11.5557 13.9653 11.8794 13.5661 11.8794H8.74682C8.34758 11.8794 8.02393 11.5557 8.02393 11.1565Z" fill="currentColor"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M18.8387 18.8387C19.121 18.5564 19.5787 18.5564 19.861 18.8387L21.7887 20.7664C22.071 21.0487 22.071 21.5064 21.7887 21.7887C21.5064 22.071 21.0487 22.071 20.7664 21.7887L18.8387 19.861C18.5564 19.5787 18.5564 19.121 18.8387 18.8387Z" fill="currentColor"/>
</svg>
`,
  "fill": `
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.2944 11.1429C8.2944 10.7221 8.63257 10.381 9.04972 10.381H13.0781C13.4953 10.381 13.8335 10.7221 13.8335 11.1429C13.8335 11.5637 13.4953 11.9048 13.0781 11.9048H9.04972C8.63257 11.9048 8.2944 11.5637 8.2944 11.1429Z" fill="currentColor"/>
...
const MinimalisticMagniferZoomOut = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
...
exports.MinimalisticMagniferZoomOut = MinimalisticMagniferZoomOut;
