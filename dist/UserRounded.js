...
`,
  "lineDuotone": `
<circle cx="12" cy="6" r="4" stroke-width="1.5"/>
<ellipse opacity="0.5" cx="12" cy="17" rx="7" ry="4" stroke-width="1.5"/>
</svg>
`,
  "linear": `
<circle cx="12" cy="6" r="4" stroke-width="1.5"/>
<ellipse cx="12" cy="17" rx="7" ry="4" stroke-width="1.5"/>
</svg>
`,
  "outline": `
...
const UserRounded = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
...
exports.UserRounded = UserRounded;
