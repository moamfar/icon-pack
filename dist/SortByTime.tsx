...
`,
    "lineduotone": `
<path opacity="0.5" d="M10 7L2 7" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M8 12H2" stroke-width="1.5" stroke-linecap="round"/>
<path opacity="0.5" d="M10 17H2" stroke-width="1.5" stroke-linecap="round"/>
<circle cx="17" cy="12" r="5" stroke-width="1.5"/>
<path d="M17 10V11.8462L18 13" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
...
export const SortByTime: React.FC<IconProps> = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
