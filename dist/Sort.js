...
<path d="M18.75 8C18.75 8.41421 18.4142 8.75 18 8.75H6C5.58579 8.75 5.25 8.41421 5.25 8C5.25 7.58579 5.58579 7.25 6 7.25H18C18.4142 7.25 18.75 7.58579 18.75 8Z" fill="currentColor" opacity="0.4"/>
<path d="M16.75 12C16.75 12.4142 16.4142 12.75 16 12.75H8C7.58579 12.75 7.25 12.4142 7.25 12C7.25 11.5858 7.58579 11.25 8 11.25H16C16.4142 11.25 16.75 11.5858 16.75 12Z" fill="currentColor" opacity="0.4"/>
<path d="M14.75 16C14.75 16.4142 14.4142 16.75 14 16.75H10C9.58579 16.75 9.25 16.4142 9.25 16C9.25 15.5858 9.58579 15.25 10 15.25H14C14.4142 15.25 14.75 15.5858 14.75 16Z" fill="currentColor" opacity="0.4"/>
</svg>
`,
  "broken": `
<path d="M22 7L9 7M2 7L5 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M19 12H16M5 12L12 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
...
<path opacity="0.5" d="M19 12L5 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M16 17H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>
`,
  "linear": `
...
`,
  "outline": `
<path fill-rule="evenodd" clip-rule="evenodd" d="M22.75 7C22.75 7.41421 22.4142 7.75 22 7.75L2 7.75C1.58579 7.75 1.25 7.41421 1.25 7C1.25 6.58579 1.58579 6.25 2 6.25L22 6.25C22.4142 6.25 22.75 6.58579 22.75 7Z" fill="currentColor"/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M16.75 17C16.75 17.4142 16.4142 17.75 16 17.75H8C7.58579 17.75 7.25 17.4142 7.25 17C7.25 16.5858 7.58579 16.25 8 16.25H16C16.4142 16.25 16.75 16.5858 16.75 17Z" fill="currentColor"/>
</svg>
`,
};
const Sort = ({ size = 24, color = "currentColor", weight = "outline", className = "", style = {}, ...props }) => {
