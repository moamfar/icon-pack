...
<path d="M12 7C12.5523 7 13 7.44771 13 8C13 8.55229 12.5523 9 12 9C11.4477 9 11 8.55229 11 8C11 7.44771 11.4477 7 12 7Z"/>
</svg>
`,
    "broken": `
...
export const InfoCircle: React.FC<IconProps> = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
