...
`,
    "boldduotone": `
<path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M20.75 12C20.75 11.5858 20.4142 11.25 20 11.25H10.75V12.75H20C20.4142 12.75 20.75 12.4142 20.75 12Z"/>
...
`,
    "lineduotone": `
<path opacity="0.5" d="M20 12.75C20.4142 12.75 20.75 12.4142 20.75 12C20.75 11.5858 20.4142 11.25 20 11.25V12.75ZM20 11.25H4V12.75H20V11.25Z"/>
<path d="M10 6L4 12L10 18" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
    "linear": `
...
export const ArrowLeft: React.FC<IconProps> = ({ size = 24, color = "currentColor", weight = "outline", ...props }) => {
